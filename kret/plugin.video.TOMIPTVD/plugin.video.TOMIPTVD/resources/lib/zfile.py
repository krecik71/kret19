...
def is_zipfile(filename):
    ...
    try:
        if hasattr(filename,"read"):
            ...
            with io.open(filename, "rb",buffering=1024*1024) as fp:
...
class ZipFile(object):
    ...
    def __init__(self, file, mode="r", compression=ZIP_STORED, allowZip64=False):
        ...
        if isinstance(file, basestring):
            ...
            try:
                self.fp = io.open(file, modeDict[mode],buffering=1024*1024)
            except IOError:
                if mode == 'a':
                    mode = key = 'w'
                    self.fp = io.open(file, modeDict[mode],buffering=1024*1024)
    ...
    def testzip(self):
        ...
        for zinfo in self.filelist:
            try:
                ...
                with self.io.open(zinfo.filename, "r",buffering=1024*1024) as f:
    ...
    def read(self, name, pwd=None):
        ...
        return self.io.open(name, "r",pwd,buffering=1024*1024).read()
    ...
    def open(self, name, mode="r", pwd=None):
        ...
        if self._filePassed:
            ...
            zef_file = io.open(self.filename, 'rb',buffering=1024*1024)
            should_close = True
